...
const NotificationBell = () => {
  ...
  /* ── Panel rendered via portal into document.body ── */
  ...
  return (
    <>
      <style>{`
        @keyframes bp { 0%,100%{opacity:1;transform:scale(1)} 50%{opacity:.4;transform:scale(1.2)} }
      `}</style>
        ...
        {unreadCount > 0 && (
          <>
            <span style={{
              ...
              border: "2px solid #0a0e1a", padding: "0 3px",
            }}>
